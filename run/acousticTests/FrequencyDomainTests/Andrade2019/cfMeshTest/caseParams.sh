...
# cfMesh controls [m].
CFMESH_MAX_CELL_SIZE=${CFMESH_MAX_CELL_SIZE:-1.0e-4}
CFMESH_DROP_CELL_SIZE=${CFMESH_DROP_CELL_SIZE:-3.0e-5}
# Interface-only semicircle refinement controls.
CFMESH_INTERFACE_SEGMENTS=${CFMESH_INTERFACE_SEGMENTS:-24}
