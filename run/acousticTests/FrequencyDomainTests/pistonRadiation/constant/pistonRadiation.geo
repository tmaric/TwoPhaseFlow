...
N = 10;      // cells per wavelength
gs = lambda/N;                      // cell size
gr = 1.0;                   // transfinite progression ratio

Rmin = 0.2;                // acoustic domain radius (PML starts here)
Rmax = 0.28;                // outer radius
...
Transfinite Curve {1,3} = Round(Rmax/gs) Using Progression gr;
Transfinite Curve {2} = Round(0.4*Rmax/gs);
