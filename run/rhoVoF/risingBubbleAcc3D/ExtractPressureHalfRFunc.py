...
def extractPressure(case_path):
	...
	extractCellsByRegion1.IntersectWith.Length = [0.01, 0.01, 0.01]
	...
	extractCellsAlongLine1.Point1 =[2.42859e-03/2 + 1e-05, 2.42859e-03/2 + 1e-05, -0.005] #[1e-05, 1e-05, -0.005]
	extractCellsAlongLine1.Point2 =[2.42859e-03/2 + 1e-05, 2.42859e-03/2 + 1e-05, 0.005] #[1e-05, 1e-05, 0.005]
	...
	# save data
	SaveData(absolute_path + '/Pressure_halfR.csv', proxy=extractCellsAlongLine1, ChooseArraysToWrite=1,
