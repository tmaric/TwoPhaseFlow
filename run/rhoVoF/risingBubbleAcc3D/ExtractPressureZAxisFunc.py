...
def extractPressure(case_path):
	...
	extractCellsAlongLine1.Point1 = [1e-05, 1e-05, -0.005]
	extractCellsAlongLine1.Point2 = [1e-05, 1e-05, 0.005]
	...
	# save data
	SaveData(absolute_path + '/Pressure_zAxis.csv', proxy=extractCellsAlongLine1, ChooseArraysToWrite=1,
