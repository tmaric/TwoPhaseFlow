...
renderView1.CenterOfRotation = [0.0729999989271164, 0.00112139992415905, 0.0026700000744313]
renderView1.UseLight = 0
renderView1.StereoType = 'Crystal Eyes'
renderView1.CameraPosition = [0.10205684838440127, 0.00112139992415905, 0.0026700000744313]
renderView1.CameraFocalPoint = [0.0729999989271164, 0.00112139992415905, 0.0026700000744313]
renderView1.CameraViewUp = [0.0, 0.0, 1.0]
renderView1.CameraFocalDisk = 1.0
renderView1.CameraParallelScale = 0.01612078682836938
...
a12Dfoam = OpenFOAMReader(registrationName='12D.foam', FileName='/work/scratch/lm74veso/HIGHreducedCaseFullPLICaRDF200/common/200.foam')
...
#print(tsteps)
i=0
p=214  #(luis) start frame needs to be matched manually
print(tk)
print(tsteps)
for t in tsteps:
    tk.Time=tsteps[i]   #(luis) changes the timestep
    rpm200_Layer2_Set40214 = CreateTexture(filename='/home/lm74veso/ExperimentalData/ExperimentsLuis/BW200RPM/Rpm200_Layer2_Set40'+str(p)+'.png')
    ...
    transform3.Transform.Translate = [0.0, 0.00112, -0.00051]
    ...
    # a texture
    #rpm200_Layer2_Set40214 = FindTextureOrCreate(registrationName='Rpm200_Layer2_Set40214', filename='/home/luigi/OpenFOAM/ExperimentalData/BW200RPM/Rpm200_Layer2_Set40214.png')
    ...
    textureMaptoPlane1Display.Texture = rpm200_Layer2_Set40214
    textureMaptoPlane1Display.TextureTransform = 'Transform2'
    textureMaptoPlane1Display.Scale = [1.0, 1.18, 1.18]
    ...
    textureMaptoPlane1Display.PolarAxes.Scale = [1.0, 1.18, 1.18]
    ...
    animationScene1.AnimationTime = 5.05868e-05
    animationScene1.StartTime = 5.05868e-05
    animationScene1.EndTime = 0.00196912
    ...
    # ----------------------------------------------------------------
    print(i)
    SaveScreenshot("/home/lm74veso/Results/PICs_SYNCCEDtoLOCAL_/HighCellcountvisRDF200/HighCellvisRDFContour200"+str(i)+".png")
    i=i+1
    p=p+5
