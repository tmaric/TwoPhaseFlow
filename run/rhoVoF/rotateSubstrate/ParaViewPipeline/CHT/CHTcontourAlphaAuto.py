#tate file generated using paraview version 5.13.2
import paraview
...
a12Dfoam = OpenFOAMReader(registrationName='12D.foam', FileName='/work/scratch/lm74veso/reducedCaseCHTtestRealVelo/common/CHT.foam')
...
for t in tsteps:
    ...
    transform3.Transform.Translate = [0.0, 5e-05, 0.00017]
    ...
    # a texture
    #rpm800_Layer2_Setpng = FindTextureOrCreate(registrationName='Rpm800_Layer2_Set..png', filename='/home/luigi/OpenFOAM/ExperimentalData/BW800RPM/Rpm800_Layer2_Set40180.png')
    ...
    alphawaterTF2D.ScalarRangeInitialized = 1
    alphawaterTF2D.Range = [0.24253731360659003, 1.0, 0.24253731360659003, 1.0]

    # get color transfer function/color map for 'alphawater'
    alphawaterLUT = GetColorTransferFunction('alphawater')
    alphawaterLUT.TransferFunction2D = alphawaterTF2D
    alphawaterLUT.RGBPoints = [0.0, 0.0, 0.0, 0.0, 0.40009765625000004, 0.901960784314, 0.0, 0.0, 0.8001953125000001, 0.901960784314, 0.901960784314, 0.0, 1.000244140625, 1.0, 1.0, 1.0]
    alphawaterLUT.ColorSpace = 'RGB'
    alphawaterLUT.NanColor = [0.0, 0.498039215686, 1.0]
    alphawaterLUT.NumberOfTableValues = 1
    alphawaterLUT.ScalarRangeInitialized = 1.0

    # trace defaults for the display properties.
    transform3Display.Representation = 'Surface'
    transform3Display.ColorArrayName = ['POINTS', 'alpha.water']
    transform3Display.LookupTable = alphawaterLUT
    ...
    alphawaterPWF.Points = [0.0, 0.0, 0.5, 0.0, 1.000244140625, 1.0, 0.5, 0.0, 1.000244140625, 1.0, 0.5, 0.0, 1.000244140625, 1.0, 0.5, 0.0]
    ...
    # ----------------------------------------------------------------
    print(i)
    SaveScreenshot("/home/lm74veso/Results/PICs_SYNCCEDtoLOCAL_/CHTlowCellSpeedTest/CHTlowCellSpeedTest"+str(i)+".png")
    i=i+1
    p=p+5
