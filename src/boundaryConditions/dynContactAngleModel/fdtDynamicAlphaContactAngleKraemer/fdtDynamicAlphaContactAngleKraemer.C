...
#include "error.H"
#include "fdtDynamicAlphaContactAngleKraemer.H"
...
bool Foam::fdtDynamicAlphaContactAngleKraemer::hasContactLine(label faceI) const
{
...
Foam::fdtDynamicAlphaContactAngleKraemer::
fdtDynamicAlphaContactAngleKraemer
(
    const fvPatch& p,
...
fdtDynamicAlphaContactAngleKraemer
(
    const fdtDynamicAlphaContactAngleKraemer& gcpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::fdtDynamicAlphaContactAngleKraemer::theta
(
...
void Foam::fdtDynamicAlphaContactAngleKraemer::write(Ostream& os) const
{
