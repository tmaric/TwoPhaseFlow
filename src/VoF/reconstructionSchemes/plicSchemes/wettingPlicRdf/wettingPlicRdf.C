...
{
    defineTypeNameAndDebug(wettingPlicRdf, 0);
    addToRunTimeSelectionTable(reconstructionSchemes,wettingPlicRdf, components);
}
}
...
void Foam::reconstruction::wettingPlicRdf::interpolateNormal()
{
...
void Foam::reconstruction::wettingPlicRdf::gradSurf(const volScalarField& phi)
{
    addProfilingInFunction(geometricVoF);
    leastSquareGrad<scalar> lsGrad("polyDegree1", mesh_.geometricD());
    zoneDistribute& exchangeFields = zoneDistribute::New(mesh_);
...
void Foam::reconstruction::wettingPlicRdf::setInitNormals(bool interpolate)
{
    addProfilingInFunction(geometricVoF);
    zoneDistribute& exchangeFields = zoneDistribute::New(mesh_);
...
void Foam::reconstruction::wettingPlicRdf::calcResidual
(
...
void Foam::reconstruction::wettingPlicRdf::centreAndNormalBC()
{
    addProfilingInFunction(geometricVoF);
...
Foam::reconstruction::wettingPlicRdf::wettingPlicRdf
(
...
void Foam::reconstruction::wettingPlicRdf::reconstruct(bool forceUpdate)
{
    addProfilingInFunction(geometricVoF);
    zoneDistribute& exchangeFields = zoneDistribute::New(mesh_);
...
void Foam::reconstruction::wettingPlicRdf::mapAlphaField() const
{
    addProfilingInFunction(geometricVoF);
