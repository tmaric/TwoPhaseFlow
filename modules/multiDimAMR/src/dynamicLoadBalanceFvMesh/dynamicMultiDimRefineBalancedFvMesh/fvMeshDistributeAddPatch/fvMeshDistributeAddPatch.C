...
)
{
    ...
    toDomain
        << mesh.points()
        << CompactListList<label>::pack<face>(mesh.faces()) //(LX July 2 2024(This guy already posted a pull req on github(luis))) before was here: << CompactListList<label, face>(mesh.faces())
        << mesh.faceOwner()
        << mesh.faceNeighbour()
        << mesh.boundaryMesh()
...
)
{
    ...
    faceList domainFaces = CompactListList<label>(fromNbr).unpack<face>(); //(LX July 2 2024(This guy already posted a pull req on github(luis))) before was here: faceList domainFaces = CompactListList<label, face>(fromNbr)();
