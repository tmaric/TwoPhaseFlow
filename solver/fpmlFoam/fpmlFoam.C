...
Description
    Simplified frequency-domain acoustic solver with cylindrical PML only
    and isotropic damping (scalar PML coefficients).
\*---------------------------------------------------------------------------*/
